...
def test_generate_all_calls_generators(
    mock_generate_clicks, mock_ensure_dirs, mock_basic_sine, mock_harmonic, mock_dynamics,
    mock_pitch_mod, mock_noisy, mock_reverb, mock_chords, mock_polyphony, mock_percussion,
    mock_mixed, mock_complex, mock_vibrato, mock_pitch_bend, mock_slow_attack, mock_staccato,
    mock_pianissimo, mock_octave_errors, mock_inharmonicity, mock_legato, mock_vocal
):
