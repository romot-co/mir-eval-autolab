...
try:
    ...
    pytest.skip("Skipping structures/note tests due to missing src modules", allow_module_level=True)
...
def test_note_creation_and_attributes():
    ...
    note_instance = Note(start_time=start, end_time=end, pitch=pitch_midi, velocity=velocity_val)
...
def test_note_default_velocity():
    ...
    try:
        ...
        pytest.skip("Skipping default velocity test - velocity might be required or has no default.")
