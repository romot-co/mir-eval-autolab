...
async def list_jobs_endpoint(
    ...
    try:
        ...
        return {"status": "success", "jobs": job_dicts, "count": len(job_dicts)}
...
async def get_running_jobs_endpoint(
    ...
    try:
        ...
        return {"status": "success", "running_jobs": job_dicts, "count": len(job_dicts)}
    except Exception as e:
        logger.error(f"Error getting running jobs: {e}", exc_info=True)
        return {"status": "error", "message": f"Failed to get running jobs: {str(e)}"}
...
async def get_worker_status_endpoint(
    ...
    try:
        ...
        return {"status": "error", "message": f"Failed to get worker status: {str(e)}"}
